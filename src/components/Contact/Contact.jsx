	...
	return (
		<div className='contact'>
			...
			<p className='sub-heading'>
				If you wish to contact us, please send us a message, give us a
				call or a vist.
			</p>
			<div className='inner-contact-page'>
				...
				<div className='reach-us'>
					<div className='office-box' id='maharashtra'>
						...
						<div className='mid'>
							<p>
								No. 24, Ground Floor, Gyaneshwari, Aarey Road
								Peru Baug, Goregaon East, Goregaon West,
					...
					<div className='office-box' id='delhi'>
						...
						<div className='mid'>
							<p>
								5852/53, Basti Harpool Singh 1st Floor, Sadar
								Bazaar, Sadar Bazaar, New Delhi, Delhi 110006
							</p>
